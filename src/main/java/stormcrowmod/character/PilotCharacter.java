package stormcrowmod.character;
...
import stormcrowmod.relics.ParticleShield;

import java.util.ArrayList;

import static stormcrowmod.StormcrowMod.characterPath;
...
public class PilotCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Pilot"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public void doCharSelectScreenSelectEffect() {
        ...
        CardCrawlGame.sound.playA("ATTACK_FLAME_BARRIER", MathUtils.random(-0.2F, 0.2F));
